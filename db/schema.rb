...
ActiveRecord::Schema.define(version: 2024_08_14_023242) do
  ...
  create_table "folder_profiles", force: :cascade do |t|
    ...
    t.index ["folder_id"], name: "index_folder_profiles_on_folder_id"
    t.index ["profile_id"], name: "index_folder_profiles_on_profile_id"
  end
